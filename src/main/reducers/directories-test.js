...
describe('directories reducers', () => {
    ...
    it('should remove directories from state', () => {
      const store = createStore(directories, {
        '_root_': {id: '_root_', children: ['a']},
        'a': {id: 'a', parent: '_root_', name: 'root', filename: '/', children: ['b']},
        'b': {id: 'b', parent: 'a', name: 'bla', filename: '/bla', children: ['c']},
        'c': {id: 'c', parent: 'b', name: 'blub', filename: '/blub', children: []}
      })
